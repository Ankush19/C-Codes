...
{
    public class MyTables1Controller : Controller
    {
        ...
        // GET: MyTables1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: MyTables1/Create
